      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="text-center p-3 bg-gradient-to-br from-red-50 to-red-100/50 rounded-lg border border-red-100">
              <div className="text-xs text-red-600 mb-1 font-medium">Total Deals Closed</div>
